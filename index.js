...
// Telegram Bot Token
const token = 'YOUR_TELEGRAM_BOT_TOKEN'; // buat bot t.me/BotFather

// Pterodactyl API configurations
const pterodactylApiUrl = 'YOUR_DOMAIN'; // Masukan Domain Panel
const pterodactylApiKey = 'YOUR_PTERODACTYL_API_KEY'; // Apikey Panel

// Owner contact information
let ownerContact = 'YOUR_OWNER_ID'; // dapatkan di bot t.me/getidsbot

// URL for Telegram thumbnail
const thumbPath = 'YOUR_THUMB_LINK'; // Ganti Link Thumb Lu
